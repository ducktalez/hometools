...
### Playlist-Redesign — Sprint 3: Filesystem-Ordner Reorder (custom_order)
- **custom_order-Persistierung pro Ordner** — Benutzer-definierte Reihenfolge in Filesystem-Ordnern (nicht nur Playlists) über `<cache_dir>/custom_order/<hash>.json` speichern. DnD nur bei Sort-Option „Liste" + filenames-Modus. Neues Backend-Modul.
